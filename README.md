Latest Version
--------------
##### _March 29, 2023_ - [v2.3.3](https://github.com/devtodev-analytics/android-sdk-2.0/releases/latest)

```
If you use Gradle, please add mavenCentral() into gradle.build of your application then:
- for using analytics add the line 
implementation ‘com.devtodev:android-analytics:2.3.3’
...
implementation ‘com.devtodev:android-messaging:2.3.3’
into dependencies.
```
