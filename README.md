Latest Version
--------------
##### _December 5, 2022_ - [v2.3.0](https://github.com/devtodev-analytics/android-sdk-2.0/releases/latest)

```
If you use Gradle, please add mavenCentral() into gradle.build of your application then:
- for using analytics add the line 
implementation ‘com.devtodev:android-analytics:2.3.0’
...
implementation ‘com.devtodev:android-messaging:2.3.0’
into dependencies.
```
